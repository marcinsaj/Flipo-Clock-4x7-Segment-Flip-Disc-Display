    ...
    {      
      switch(settings_level) 
      {
        ...
        case 1:
          ...
          if(set_rest_period == 0){rest_period = OFF; Flip.Matrix_7Seg(R,CLR,O,F); Serial.println("OFF");}
          if(set_rest_period == 1){rest_period = ON; Flip.Matrix_7Seg(R,CLR,O,N); Serial.println("ON");}
        break;
        ...
        case 3:
          Serial.print("Sleep time: ");
          if(set_am_pm == 0) {sleep_set_am_pm = AM; Flip.Matrix_7Seg(S,CLR,A,M); Serial.println("AM");}
          if(set_am_pm == 1) {sleep_set_am_pm = PM; Flip.Matrix_7Seg(S,CLR,P,M); Serial.println("PM");}
        break;
        ...
        case 5:
          Serial.print("Wake time: ");
          if(set_am_pm == 0) {wake_set_am_pm = AM; Flip.Matrix_7Seg(W,CLR,A,M); Serial.println("AM");}
          if(set_am_pm == 1) {wake_set_am_pm = PM; Flip.Matrix_7Seg(W,CLR,P,M); Serial.println("PM");}
        break;
      }
